...
#	print("{:>5.3f} {:>5.3f} {:>5.3f} {:>5.3f} {:>5.3f} {:>5.3f} ".format(PT1,PT2,PT3,PT4,PT5,PT6))
	dataMat.append([PT1,PT2,PT3,PT4,PT5,PT6])

def return2zero(INA, INB):			
	print("All motors go back")
	#run(INA[0],INB[0],-0.5,0)
	#run(INA[1],INB[1],-0.5,1)
	#run(INA[2],INB[2],-0.5,2)
	#run(INA[3],INB[3],-0.5,3)
	#run(INA[4],INB[4],-0.5,4)
	#run(INA[5],INB[5],-0.5,5)
